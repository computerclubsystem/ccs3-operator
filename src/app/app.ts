...
import {
  ...
  RouteNavigationService, AccountMenuItem, AccountMenuItemId, IconName, MainMenuItem, MainMenuItemId,
...
export class AppComponent implements OnInit {
  ...
  processFailureReplyMessageReceived(msg: ReplyMessage<unknown>): void {
    ...
    this.notificationSvc.show(NotificationType.error, translate(`Reply message '(messageType)' indicates failure`, { messageType: type }), errorsText, IconName.error, msg);
  }
