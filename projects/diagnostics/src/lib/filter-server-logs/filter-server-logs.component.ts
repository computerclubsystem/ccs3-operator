...
@Component({
  ...
  templateUrl: 'filter-server-logs.component.html',
  imports: [
...
export class FilterServerLogsComponent implements OnInit {
  ...
  processFilterServerLogsReplyMessage(replyMsg: FilterServerLogsReplyMessage): void {
    ...
    this.notificationsSvc.show(NotificationType.success, 'Server log filtering succeeded', null, IconName.check, replyMsg);
  }
