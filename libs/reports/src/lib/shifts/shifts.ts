...
import {
  FullDatePipe, MessageTransportService, MoneyFormatPipe, NotificationType, TimeConverterService
...
export class ShiftsComponent implements OnInit {
  ...
  onLoadShifts(): void {
    ...
    if (!formValue.fromDate || !formValue.toDate) {
      this.notificationSvc.show(NotificationType.warn, translate(`Both 'From' and 'To' dates are required`));
      return;
    }
