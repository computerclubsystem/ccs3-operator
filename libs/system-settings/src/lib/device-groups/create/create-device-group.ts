...
import { MessageTransportService, NotificationType, SorterService, IconName } from '@ccs3-operator/shared';
import { NotificationService } from '@ccs3-operator/notification';

@Component({
  selector: 'ccs3-op-system-settings-create-device-group',
  templateUrl: 'create-device-group.html',
  imports: [
...
export class CreateDeviceGroupComponent implements OnInit {
  ...
  processUpdateDeviceGroupReplyMessage(replyMsg: UpdateDeviceGroupReplyMessage): void {
    ...
    this.notificationSvc.show(NotificationType.success, translate('Device group updated'), null, IconName.check, replyMsg);
  }
  ...
  processCreateDeviceGroupReplyMessage(replyMsg: CreateDeviceGroupReplyMessage): void {
    ...
    this.notificationSvc.show(NotificationType.success, translate('Device group created'), null, IconName.check, replyMsg);
  }
