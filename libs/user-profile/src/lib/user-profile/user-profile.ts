...
import { HashService, MessageTransportService, NotificationType, IconName } from '@ccs3-operator/shared';
...
export class UserProfileComponent implements OnInit {
  ...
  processUpdateActionsAndOptionsButtonsPlacementReplyMessage(replyMsg: UpdateProfileSettingsReplyMessage): void {
    ...
    this.notificationSvc.show(NotificationType.success, translate('Actions and Options buttons placement saved'), null, IconName.check, replyMsg);
  }
  ...
  processUpdateCustomCssReplyMessage(replyMsg: UpdateProfileSettingsReplyMessage): void {
    ...
    this.notificationSvc.show(NotificationType.success, translate('Custom CSS saved'), null, IconName.check, replyMsg);
  }
  ...
  processChangePasswordReplyMessage(replyMsg: ChangePasswordReplyMessage): void {
    ...
    this.notificationSvc.show(NotificationType.success, translate('Password has been changed'), null, IconName.check, replyMsg);
  }
